...
public:
	...
	void colourShadeTileMap(std::shared_ptr<TileMap> map, int r, int g, int b, int a, float tileAmount, unsigned int maxTileExtentX, unsigned int maxTileExtentY, unsigned int shadeSteps, bool randomise = false, Vector2d* areaPos = nullptr);
...
private:
	...
	void colourShadeTiles(std::shared_ptr<TileMap> map, int r, int g, int b, int a, unsigned int maxTileExtentX, unsigned int maxTileExtentY, unsigned int shadeSteps, bool randomise = false, Vector2d* areaPos = nullptr);
};
