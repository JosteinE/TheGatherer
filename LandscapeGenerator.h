...
public:
	...
	void colourShadeTileMap(std::shared_ptr<TileMap> map, int r, int g, int b, int a, double tileAmount, unsigned int minTileExtentX, unsigned int minTileExtentY, unsigned int maxTileExtentX, unsigned int maxTileExtentY, unsigned int shadeSteps, bool randomise = false, Vector2d* areaPos = nullptr);
...
private:
	...
	void colourShadeTiles(std::shared_ptr<TileMap> map, int r, int g, int b, int a, unsigned int minTileExtentX, unsigned int minTileExtentY, unsigned int maxTileExtentX, unsigned int maxTileExtentY, unsigned int shadeSteps, bool randomise = false, Vector2d* areaPos = nullptr);
};